...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var STRENGTH_LEVELS = [
        { label: 'Enter a new password', color: 'var(--adm-border-color)', width: '0%' },
        { label: 'Weak', color: 'var(--adm-danger)', width: '25%' },
        { label: 'Fair', color: 'var(--adm-warning)', width: '50%' },
        { label: 'Good', color: '#3b82f6', width: '75%' },
        { label: 'Strong', color: 'var(--adm-success)', width: '100%' }
    ];
