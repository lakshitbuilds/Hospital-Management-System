...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var STRENGTH_LEVELS = [
        { label: 'Enter a new password', color: 'var(--doc-border-color)', width: '0%' },
        { label: 'Weak', color: 'var(--doc-danger)', width: '25%' },
        { label: 'Fair', color: 'var(--doc-warning)', width: '50%' },
        { label: 'Good', color: '#3b82f6', width: '75%' },
        { label: 'Strong', color: 'var(--doc-success)', width: '100%' }
    ];
    ...
    /* ----------------------------------------------------------------------
       4. Submit Validation
       Only blocks the submit when something is actually invalid. A fully
       valid form is left alone and submits to the server normally -
       faking a success message here would repeat the profile.js bug.
    ---------------------------------------------------------------------- */
